...
function computeEvmAddress(publicKey) {
  ...
  const hash = sha3.keccak_256(key);
  const addressBytes = hash.slice(-20);
  return `0x${Buffer.from(addressBytes).toString("hex")}`;
}
var TVAWalletAdapter = class extends eventemitter3.EventEmitter {
  provider = null;
  stellarKeypair = null;
  evmAddress = null;
  chainId = null;
...
exports.TVAWalletAdapter = TVAWalletAdapter;
exports.computeEvmAddress = computeEvmAddress;
exports.deriveStellarKeypairFromEvmKey = deriveStellarKeypairFromEvmKey;
exports.deriveStellarKeypairFromSignature = deriveStellarKeypairFromSignature;
exports.evmAddressToDisplayAddress = evmAddressToDisplayAddress;
exports.getKeyDerivationMessage = getKeyDerivationMessage;
exports.getKeyDerivationTypedData = getKeyDerivationTypedData;
exports.getWalletAdapter = getWalletAdapter;
exports.publicKeyBytesToStellarAddress = publicKeyBytesToStellarAddress;
exports.resetWalletAdapter = resetWalletAdapter;
exports.stellarAddressToPublicKeyBytes = stellarAddressToPublicKeyBytes;
exports.validateDerivedAddress = validateDerivedAddress;
